...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    public void handleOnClick(View view) {
        ...
        if (ad.taskId >= 0) {
            ...
            // If that task was split viewed, a normal press wil
            // resume it to normal fullscreen view
    ...
    public void openInSplitView(ViewHolder holder, int location) {
        if (holder != null) {
            ...
            throw new IllegalStateException("no tag on view to split!");
        }
    }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.recent_remove_item) {
                    ...
                    // Either start a new activity in split view, or
                    // move the current task to front, but resized
